...
export class Portal {
    ...
    */
    constructor(event: EventPanelData, TransformArgs: TransformConstructorArgs) {
    ...
    */
    private setPortalEntities() {
        ...
        if (this.eventLifeText == null) {
            ...
            this.eventLifeText.addComponent(new GLTFShape("src/portal/model/portal_live_now.glb"))
        ...
        if (this.portalAnimated == null) {
            ...
            this.portalAnimated.addComponent(new GLTFShape("src/portal/model/pride_portal.glb"))
    ...
    private createImagePortal() {
        ...
        this.portalImage.getComponent(Material).alphaTexture = new Texture("src/portal/image/portal_mask_01.png")
